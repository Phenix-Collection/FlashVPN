...
public class PreferenceUtils {
    ...
    public static int getDifficulty() {
        return getInt(MApp.getApp(),"difficulty" , 15);
    }

    public static void setDifficulty(int level) {
        putInt(MApp.getApp(),"difficulty", level);
    }

    public static int getGameCount() {
        return getInt(MApp.getApp(),"game_count", 0);
    }
    public static void incGameCount() {
        putInt(MApp.getApp(),"game_count", getGameCount() + 1);
    }

    public static int getCellSize() {
        return getInt(MApp.getApp(),"cellsize" , DisplayUtils.dip2px(MApp.getApp(), 40));
    }
