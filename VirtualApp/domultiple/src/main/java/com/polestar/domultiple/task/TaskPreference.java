...
public class TaskPreference {
    ...
    private static SharedPreferences getSharedPreference(){
       return PolestarApp.getApp().getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
    }

    private static SharedPreferences getTaskSharedPreference(long taskId){
        return PolestarApp.getApp().getSharedPreferences(PREFERENCE_NAME+"_" + taskId, Context.MODE_PRIVATE);
    }
