...
public class ColorUtils {
    ...
    public static int getIconMainColor(String app, Drawable icon) {
        ...
        int color = PreferencesUtils.getInt(PolestarApp.getApp(), app + SUFFIX, Color.TRANSPARENT);
        ...
        if (colors.size() == 0) {
            ...
            PreferencesUtils.putInt(PolestarApp.getApp(), app + SUFFIX, DEFAULT_COLOR);
        ...
        PreferencesUtils.putInt(PolestarApp.getApp(),app + SUFFIX, color);
        if (DEBUG) {
