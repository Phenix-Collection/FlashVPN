...
public class TaskExecutor {
    ...
    private AppUser PolestarAppUser;
    ...
    public TaskExecutor(Context context) {
        mContext = context;
        PolestarAppUser = AppUser.getInstance();
...
//                }
            ...
            case Task.TASK_TYPE_RANDOM_AWARD:
                PolestarAppUser.finishTask(task, listener);
                break;
            ...
            case Task.TASK_TYPE_REFER_TASK:
                ...
                if (code.equals(PolestarAppUser.getInviteCode())) {
                    listener.onTaskFail(task.mId, new ADErrorCode(ADErrorCode.INVALID_REFERRAL_CODE, ""));
                    return;
                }
                PolestarAppUser.submitInviteCode(task, (String)args[0], listener);
                break;
    ...
    private class WrapTaskStatusListener implements ITaskStatusListener{
        ...
        public void onTaskSuccess(long taskId, float payment, float balance) {
            ...
            PolestarAppUser.updateMyBalance(balance);
