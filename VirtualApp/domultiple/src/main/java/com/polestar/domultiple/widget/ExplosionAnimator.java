...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = DisplayUtils.dip2px(PolestarApp.getApp(),5);
    private static final float Y = DisplayUtils.dip2px(PolestarApp.getApp(),20);
    private static final float V = DisplayUtils.dip2px(PolestarApp.getApp(),2);
    private static final float W = DisplayUtils.dip2px(PolestarApp.getApp(),1);
