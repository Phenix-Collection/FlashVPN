    ...
    private void initView() {
        ...
        shortCutSwich.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PreferencesUtils.putBoolean(SettingsActivity.this,Constants.KEY_AUTO_CREATE_SHORTCUT,shortCutSwich.isChecked());
            }
        });
    }
    ...
    public void onFollowUsClick(View view) {
        try {
            ...
            if (packageInfo != null && packageInfo.versionCode >= 3002850) {
                Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("fb://facewebmodal/f?href=" + Constants.URL_FACEBOOK));
//                intent.putExtra("START_OUTTER_APP_FLAG",true);
                startActivity(intent);
            }else{
                Intent intent = new Intent("android.intent.action.VIEW",Uri.parse(Constants.URL_FACEBOOK));
//                intent.putExtra("START_OUTTER_APP_FLAG",true);
                startActivity(intent);
            }
