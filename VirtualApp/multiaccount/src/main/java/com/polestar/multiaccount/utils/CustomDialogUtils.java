...
public class CustomDialogUtils {
    ...
    public static Dialog showCustomDialogWithoutTitle(Context context, String content, String leftBtnName, String rightBtnName, final DialogInterface.OnClickListener onClickListener) {
        return showCustomDialog(context, null, content, leftBtnName, rightBtnName, onClickListener);
    }

    public static Dialog showCustomDialog(Context context, String title, String content, String leftBtnName, String rightBtnName, final DialogInterface.OnClickListener onClickListener) {
