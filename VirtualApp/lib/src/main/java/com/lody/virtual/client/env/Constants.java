...
public class Constants {
	...
	public static final String ACTION_PACKAGE_ADDED = VIRTUAL_PROTECT_INTENT_PREFIX + Intent.ACTION_PACKAGE_ADDED;
	public static final String ACTION_PACKAGE_REMOVED = VIRTUAL_PROTECT_INTENT_PREFIX + Intent.ACTION_PACKAGE_REMOVED;
	public static final String ACTION_PACKAGE_CHANGED = VIRTUAL_PROTECT_INTENT_PREFIX + Intent.ACTION_PACKAGE_CHANGED;
	...
	public static final String ACTION_USER_ADDED = VIRTUAL_PROTECT_INTENT_PREFIX + "android.intent.action.USER_ADDED";
	public static final String ACTION_USER_REMOVED = VIRTUAL_PROTECT_INTENT_PREFIX + "android.intent.action.USER_REMOVED";
	public static final String ACTION_USER_INFO_CHANGED = VIRTUAL_PROTECT_INTENT_PREFIX + "android.intent.action.USER_CHANGED";

	public static final String ACTION_USER_STARTED = VIRTUAL_PROTECT_INTENT_PREFIX + "android.intent.action.USER_STARTED";
