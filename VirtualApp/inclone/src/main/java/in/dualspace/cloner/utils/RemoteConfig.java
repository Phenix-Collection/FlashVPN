...
import in.dualspace.cloner.clone.PackageConfig;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by DualApp on 2016/12/17.
 */
    ...
    public static void init () {
        ...
        mFirebaseRemoteConfig.fetch(cacheTime).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                PreferencesUtils.putString(DualApp.getApp(), "conf_intercept_class", RemoteConfig.getString("conf_intercept_class"));
