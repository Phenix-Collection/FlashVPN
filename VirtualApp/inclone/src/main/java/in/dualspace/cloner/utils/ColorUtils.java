...
public class ColorUtils {
    ...
    public static int getIconMainColor(String app, Drawable icon) {
        ...
        int color = PreferencesUtils.getInt(DualApp.getApp(), app + SUFFIX, Color.TRANSPARENT);
        ...
        if (colors.size() == 0) {
            ...
            PreferencesUtils.putInt(DualApp.getApp(), app + SUFFIX, DEFAULT_COLOR);
        ...
        PreferencesUtils.putInt(DualApp.getApp(),app + SUFFIX, color);
        if (DEBUG) {
