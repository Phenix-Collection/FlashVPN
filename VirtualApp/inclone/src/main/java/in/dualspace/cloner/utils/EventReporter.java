...
public class EventReporter {
    ...
    public static void init(Context context) {
        mFirebaseAnalytics = FirebaseAnalytics.getInstance(DualApp.getApp());
    ...
    public static void reportRate(String status, String from) {
        ...
        bundle.putString("from", from);
        long installTime = CommonUtils.getInstallTime(DualApp.getApp(), DualApp.getApp().getPackageName());
