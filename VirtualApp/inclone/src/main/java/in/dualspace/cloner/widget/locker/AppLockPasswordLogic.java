...
/**
 * Created by DualApp on 2017/1/3.
 */
...
//        mLockPatternView.setGreenPathPaintColor(TITLE_COLOR_WHITE);
        ...
        int screenWidth = DisplayUtils.getScreenWidth(DualApp.getApp());
    ...
    public void onShow() {
        ...
        if (mLockPatternView != null) {
            mLockPatternView
                    .setInStealthMode(PreferencesUtils.getAppLockInVisiablePatternPath(DualApp.getApp()));
        }
    ...
    private final LockPatternView.OnPatternListener mPatternListener = new LockPatternView.OnPatternListener() {
        ...
        public void onPatternDetected(List<LockPatternView.Cell> pattern) {
            if (LockPatternUtils.isPatternMatched(pattern)) {
                PreferencesUtils.setLockScreen(DualApp.getApp(),false);
