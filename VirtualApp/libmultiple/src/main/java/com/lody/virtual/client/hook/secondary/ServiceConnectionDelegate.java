...
public class ServiceConnectionDelegate extends IServiceConnection.Stub {
    ...
    public synchronized static IServiceConnection getDelegate(Context context, ServiceConnection connection,int flags) {
    ...
    public synchronized static IServiceConnection removeDelegate(Context context, ServiceConnection conn) {
