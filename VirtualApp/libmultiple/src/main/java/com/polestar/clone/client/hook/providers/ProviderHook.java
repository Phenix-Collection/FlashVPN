...
public class ProviderHook implements InvocationHandler {
    ...
    public AssetFileDescriptor openTypedAssetFile(MethodBox methodBox, Object[] args) throws InvocationTargetException, IllegalAccessException {
    ...
    public Object invoke(Object proxy, Method method, Object... args) throws Throwable {
        ...
        try {
            ...
            if ("call".equals(name)) {
                ...
                fakeReturn = null;
                return openTypedAssetFile(methodBox, args);
