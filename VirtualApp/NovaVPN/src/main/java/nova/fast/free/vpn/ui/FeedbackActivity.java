    ...
    private void initView() {
        ...
        mBtSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.setData(Uri.parse("mailto:magicyu2@gmail.com"));
                data.putExtra(Intent.EXTRA_SUBJECT, "Feedback about Nova VPN");
                String fullContent = content + "\n\n\n\n"  + "Additional Info: \n" + "Rating: "+ rating +  "Nova VPN version: " + BuildConfig.VERSION_NAME
